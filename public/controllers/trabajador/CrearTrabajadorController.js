...
/* jshint -W098 */
angular.module('mean.rrhh').controller('CrearTrabajadorController', function($scope, $state, Sucursal, Agencia, Trabajador, PersonaNatural, TipoDocumento, Notifications){
